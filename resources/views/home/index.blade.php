...
<html lang="en">
    <head>
        ...
        <title>Home - E- DONOR DARAH</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                {{-- <a class="navbar-brand" href="#page-top"><img src="{{ asset('home/assets/img/navbar-logo.svg')}}" alt="..." /></a> --}}
                <h2 class="text-white">E-DONOR</h2>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-danger btn-xl text-uppercase" href="#services">Daftar Sekarang</a>
            </div>
        </header>
        <!-- Services-->
