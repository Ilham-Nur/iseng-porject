                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                <span class="bg-success text-white px-2 rounded-3">Active</span>
                            </td>
                            <td>                  
                        ...
                        <tr>
                            ...
                            <td>O-</td>
                            <td class="d-flex justify-content-center">
                                <span class="bg-danger text-white px-2 rounded-3">Non Active</span>
                            </td>
                            <td>                  
                                <a href="#"><i class='bx bxs-edit'></i></a>
                                <a href="#"><i class='bx bxs-trash' ></i></a>
